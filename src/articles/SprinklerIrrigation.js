  ...
  return (
    <article className="container">
      ...
      <p>
        ...
        recognized the advantages of reliable, high-pressure water delivery for
        their watering systems.
      </p>
      <h2>What Is Sprinkler Irrigation?</h2>
      <p>
        Sprinkler irrigation is any irrigation that uses a pressurized system to
        apply water in a method that mimics rainfall to the soil surface. Water
        is delivered to a farmer’s fields through a network of pipes or hoses,
        and the water is usually pressurized using a pumping system. Irrigation
        sprinkler systems may be temporary, movable or permanent.
      </p>
      <p>
        In the United States, nearly 4.4 million acres are irrigated via some
        method of spray, aka sprinkler irrigation, not including center pivot or
        micro-spray irrigation, according to the 2018 United States Department
        of Agriculture (USDA) report “Sprinkler Irrigation in the Fields and
        Open.”
      </p>
      <p>
