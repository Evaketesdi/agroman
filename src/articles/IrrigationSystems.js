...
export default function IrrigationSystems() {
  return (
    <article className="container">
      ...
      <p>
        Irrigation itself is the artificial delivery of moisture for the benefit
        of growing crops. Farming without irrigation is considered rainfed and
        is often referred to as dryland farming.
      </p>
      <p>
        Irrigation systems, therefore, are simply the method a farmer employs to
        transport water from its source to their cultivated fields. Irrigation
        waters come from groundwater sources, such as aquifers, springs and
        wells, or surface water sources, such as rivers, ponds, or lakes.
      </p>
      <h2>The Importance of Irrigation Systems to Our Food Supply Chain</h2>
      <p>
        Globally, irrigation systems are crucial to food production and ensuring
        humans have enough to eat.
      </p>
      <p>
      ...
      <p>
        In North America, agricultural food production consumed 80% of the U.S.
        consumptive water use between 1960 and 1995, more than any other sector.
        And globally, agriculture uses 70% of the world’s available freshwater.
      </p>
      <p>
        ...
        driest in the last 1200 years, according to a March 2022 study published
