  ...
  return (
    <article className="container">
      ...
      <p>
        ...
        fruits. The amount of water required by the plant depends on the growth
        phases during the season. The highest need for water is during the
        initial crop development, flowering, and fruit setting phases.
      </p>
      <p>
      ...
      <p>
        ...
        water. Nearly 70% of water withdrawals from watercourses and groundwater
        are used in farming for crop irrigation.
      </p>
      <h2>What Is Irrigation in Agriculture</h2>
      <p>
        When it comes to agriculture, irrigation usually comes down to applying
        controlled amounts of water to assist in the production of crops, as
        well as to grow landscape plants and lawns. There are several different
        methods of watering that can be applied depending on the type of
        terrain, crop, water source availability, reservoirs, available
        infrastructure, and so on. Due to climate change and the need for
        increased food production, the amount of irrigation water has
